...
out_test1 <- run_beast(xml_path = 'test_dat1.xml', beast2_path = '~/Desktop/progs/beast2/bin/beast -overwrite', tree_ann_path = '~/Desktop/progs/beast2/bin/treeannotator -burnin 10')
...
out_test1 <- run_beast(xml_path = 'test_dat1.xml', beast2_path = '~/Desktop/progs/beast2/bin/beast/beast -overwrite', tree_ann_path = '~/Desktop/progs/beast2/bin/treeannotator -burnin 10')
#system('rm out_temp.tree')
cat(paste(s_len, mean(out_test1$node_support), out_test1$dist_t_tre, sep = ' '), file = 'seq_length_test.txt', sep = '\n', append = T)
