...
out_test1 <- run_beast(xml_path = 'test_dat1.xml', beast2_path = '/Users/sebastianducheneAIr/Downloads/BEAST2/bin/beast -overwrite', tree_ann_path = '/Users/sebastianducheneAIr/Downloads/BEAST2/bin/treeannotator -burnin 10')
