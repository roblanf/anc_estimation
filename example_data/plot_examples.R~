...
# Put true tree here
tr_true <- chronopl(read.tree('set17_10.tree '), lambda = 0.5)
...
est_chrono <- read.annotated.nexus('set17_10.trees.annotated')	
...
write.table(est_post, file = 'set17_10_post.txt')
